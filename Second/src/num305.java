...
public class num305 {
    ...
    //                 min=Math.min(min,findIdx(grid[nx][ny]));
    //         }
    //         if(min==m*n){
    //         	vidx[len]=++len;
    //             grid[x][y]=len;
    ...
    //                 int nx=x+dx[i];
    //                 int ny=y+dy[i];
    //                 if(nx>=0&&nx<m&&ny>=0&&ny<n&&grid[nx][ny]!=0&&findIdx(grid[nx][ny])!=min){
    //                     vidx[findIdx(grid[nx][ny])-1]=min;
    //                     count--;
    //                 }
    //             }
    //         }
    ...
    //                 int tem=findIdx(vidx,grid[nx][ny]);
    //                 if(tem!=-1&&tem!=idx){
    //                     vidx[idx-1]=tem;
    //                     idx=tem;
    //                     count--;
    ...
    //     return res;
    // }
    // private int findIdx(int[] vidx,int id){
    // 	if(id==0)
    // 		return -1;
    //     while(vidx[id-1]!=id)
    //         id=vidx[id-1];
...
//				{{8,5},{8,0},{3,4},{0,3},{1,0},{5,4},{0,8},{5,7},{0,6},{6,2},{4,7},{2,7},{8,7},{8,6},{5,3},{2,3},{3,5},{3,1},{0,2},{8,8},{6,4},{0,1},{0,4},{7,5},{3,0}};
